...
<body>
	...
	<div class="container app">
		...
		<?php if (isset($_GET['cadastro']) && $_GET['cadastro'] == 1) { ?>
			<!-- Teste para saber se o cadastro foi realizado com sucesso-->

			<div class="bg-success d-flex text-white justify-content-center my-3">
		...
		<div class="row">
			<div class="col-md-3 menu">
				<ul class="list-group">
					<li class="list-group-item"><a href="index.php">Tarefas pendentes/atrasadas</a></li>
